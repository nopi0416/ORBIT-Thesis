            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#4c5fd5]/10 rounded-lg">
                  <ShieldCheck className="w-6 h-6 text-[#4c5fd5]" />
                </div>
                <h2 className="text-3xl font-bold text-white">Security Questions</h2>
              </div>
              <p className="text-gray-300">Set up security questions for account recovery</p>
            </div>

            <SecurityQuestionsForm email={email} role={role} />
